...
try {
    ...
    console.log("Opentype Font Object bounds (head table):");
    if(font.tables && font.tables.head) {
        console.log("xMin:", font.tables.head.xMin);
        console.log("yMin:", font.tables.head.yMin);
        console.log("xMax:", font.tables.head.xMax);
        console.log("yMax:", font.tables.head.yMax);
    } else {
        console.log("Head table is missing!");
    }
